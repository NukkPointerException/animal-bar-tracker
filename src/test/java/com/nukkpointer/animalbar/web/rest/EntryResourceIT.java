...
import com.nukkpointer.animalbar.service.EntryService;
...
import static com.nukkpointer.animalbar.web.rest.TestUtil.sameInstant;
...
public class EntryResourceIT {
    ...
    private static final String DEFAULT_PUBLIC_ID = "AAAAAAAAAA";
    private static final String UPDATED_PUBLIC_ID = "BBBBBBBBBB";
    ...
    public void createEntry() throws Exception {
        ...
        assertThat(testEntry.getPublicId()).isEqualTo(DEFAULT_PUBLIC_ID);
    }
    ...
    public void updateEntry() throws Exception {
        ...
        assertThat(testEntry.getPublicId()).isEqualTo(UPDATED_PUBLIC_ID);
    }
